...
<ul>
  ...
  <li style="float:right"><button onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Signup</button></li>
  <li style="float:right"><p> </p></li>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="Signup"  method="post">
    <div class="imgcontainer">
      ...
      <img src="images/img_avatar1.png" style="width:100px;" alt="Avatar" class="avatar">
    </div>
