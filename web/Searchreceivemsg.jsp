...
<div class="container">
	<div class="search">
			...
			<input name="searchbar" type="text" onkeyup="searchsendmsg()" id="searchsendmessage" placeholder="Search for username..">
			<input style="height:52px;" onclick="searchsendmsg()" type="submit" value="Submit">
...
<script>
	...
	function searchsendmsg(){
	var email = $("#searchsendmessage").val();
		$.ajax({
		type: "POST",
		url: "http://localhost:8080/emailjsp/searchreceivemessageAjax",
...
<center><input class='cancelbtn' type="button" style="border: none;" onclick='deleteall()' id="save_value" name="save_value" value="Delete Selected Messages" /></center>
